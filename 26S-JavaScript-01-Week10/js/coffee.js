...
class coffee {
    ...
    serveIt(){
        ...
        cup.setAttribute("src","image/coffee-cup.svg");//<img src="image/coffee-cup.svg">
        // Determine caffeine status of the coffee
        if(this.isDecaf){
             cup.setAttribute("src","image/coffee-cup-green.svg");//<img src="image/coffee-cup-green.svg">
        }else{
             cup.setAttribute("src","image/coffee-cup-purple.svg");//<img src="image/coffee-cup-purple.svg">
        }
        ...
        cup.setAttribute("title", `a ${this.size}`)
...
//lab 2 extra subclass
class icedCoffee extends Coffee{
    ice;
    constructor(size, isDecaf, ice){
        super(size, isDecaf);
        this.ice = ice;
    }
    icedCoffeeDesc(){
        return `a ${this.size} sized iced coffee with ${this.iced} ice cubes`
    }
}

let myIceCoffee = new icedCoffee("large", false , "4")


myIceCoffee.icedCoffeeDesc();
